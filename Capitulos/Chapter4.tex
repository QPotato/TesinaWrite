...
\section{Preservación del juego ficticio} \label{sec:aportes:preservacion} \cambios{Esta sección estoy en proceso de hacerle varios cambios. Más detalles en el mail.}
