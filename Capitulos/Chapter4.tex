...
\begin{proof}
    % Creo que vale la misma demostracion de suma cero???
    % Por eso queria demostrar simatricos???
    Definimos el juego $A'$ como
    \begin{equation*}
        A' =
        \begin{pmatrix}
