...
\comentario{Dejo las dos representaciones que se me ocurrieron, para mostrartelas, pero me gusta mas la segunda y la idea es dejar esa sola.}
...
\begin{definition}
    Un juego $(A, B)$ de tamaño $n \times m$ es un \concept{juego de intereses idénticos} si $\forall i \in N, j \in M : a_{ij} = b_{ij}$. En este caso también nos referiremos al juego usando solo la matriz $A$. \cambios{esta ultima oracion}
\end{definition}
...
\section{Ejemplos} \cambios{esta sección}
