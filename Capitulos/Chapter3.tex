...
\begin{definition} \label{def:fp:brandt}
    ...
    \begin{itemize}
        ...
        \begin{gather*}
            ...
            x^{\tau+1} = x^{\tau} + \pstrat{i} \text{\ donde $i = d_1(argmax_{i \in N}\{\pstrat{i}Ay^\tau\})$} \\
            y^{\tau+1} = x^{\tau} + \pstrat{j} \text{\ donde $j = d_2(argmax_{j \in M}\{x^{\tau}B\pstrat{j}\})$}
        \end{gather*}
        ...
        \begin{gather*}
            x^0 = \boldmath{0}, y^0 = \boldmath{0} \\
            x^{\tau+1} = x^{\tau} + \pstrat{i} \text{\ donde $i = d_1(argmax_{i \in N}\{\pstrat{i}Ay^\tau\})$} \\
            y^{\tau+1} = y^{\tau} + \pstrat{j} \text{\ donde $j = d_2(argmax_{j \in M}\{x^{\tau}B\pstrat{j}\})$}
        \end{gather*}
    \end{itemize}
\end{definition}
