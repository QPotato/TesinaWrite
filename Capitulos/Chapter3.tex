...
\begin{definition}
    Un juego $(A, B)$ de tamaño $n \times n$ es un \concept{juego simétrico} si $\forall i, j \in N : a_{ij} = -b_{ji}$. En este caso también nos referiremos al juego usando solo la matriz $A$.
\end{definition}
