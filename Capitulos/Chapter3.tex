...
\begin{definition}
    Sea $(i^\tau, j^\tau)$ una secuencia de juego ficticio (simultaneo o alternante). Diremos que $(i^\tau, j^\tau)$ \concept{converge en creencias} si existe un equilibrio de Nash mixto tal que para todo $\epsilon > 0$ existe un $k \in \mathbb{N}$ tal que $|x^* - x^k| < \epsilon$ y $|y^* - y^k| < \epsilon$.
\end{definition}
